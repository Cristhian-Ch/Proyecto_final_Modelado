...
# ==================================================
"""
El método iterativo de Jacobi calcula la solución de un sistema
lineal Ax = b usando aproximaciones sucesivas.
...
class JacobiApp:
    def __init__(self, root):
        self.root = root
        self.root.title("🔁 Método Iterativo de Jacobi - Sistemas Lineales")
    ...
    def setup_ui(self):
        ...
        ttk.Label(main_frame, text="MÉTODO ITERATIVO DE JACOBI",
                  font=("Arial", 16, "bold"), foreground="#2c3e50").pack(pady=(0, 10))

        ttk.Label(main_frame,
                  text="Calcula soluciones aproximadas de Ax = b usando el método de Jacobi",
    ...
    def resolver(self):
        try:
            ...
            iteraciones, x_final = jacobi(A, b, tol, max_it)
    ...
    def mostrar_resultados(self, iteraciones, x_final):
        ...
        # Gráfica del error
        self.ax.clear()
        self.ax.plot(range(1, len(errores)+1), errores, marker='o', linewidth=2)
        self.ax.set_xlabel("Iteraciones", fontweight='bold')
        self.ax.set_ylabel("Error (∞-norma)", fontweight='bold')
        self.ax.set_title("Convergencia del Método de Jacobi", fontweight='bold')
